# This program creates instances movies I enjoyed watching and displays it on an dynamically generated webpage
import media
...
# Creating a list so I can pass it into fresh_tomatoes that will generate the dynamic page for me
movies = [big_hero_6, serenity, pokemon_the_first_movie, wreck_it_ralph, ip_man, shanghai_noon]

# Generate the HTML page in the same folder
